...
class Index extends Component {
    ...
    getDats(){
        ...
        axioApi.get('/api/role/list?'+qs.stringify(filter)).then((res) => {
          $this.setState({
    ...
    deletePost(id){
        axioApi.post('/api/role/remove', {_id : id}).then((res) => {
            $this.getDats()
        });
    }
    tabRows(){
          ...
          <Col>
            <Card>
              <CardHeader>
                ...
                <Link to="/role/create"><button className="btn btn-sm btn-success flor"><i className="fa fa-plus" aria-hidden="true"></i> Thêm</button></Link>
              </CardHeader>
