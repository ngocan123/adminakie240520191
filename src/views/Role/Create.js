...
getListCat(){
  axioApi.get('/api/role/getAll').then((res) => {
    $this.setState({
...
savePost(){
  ...
  axioApi.post('/api/role/store', postdata).then((res) => {
            ...
            <Card>
              ...
              <CardBody>
                <div className="form-group">
                  <Label htmlFor="name"><strong>Tên vai trò</strong></Label>
                  <Input type="text" onChange={this.changeName} id="name" placeholder="Tên vai trò" />
                </div>
                <div className="form-group">
