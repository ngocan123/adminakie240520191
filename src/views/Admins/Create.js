...
class Create extends Component {
  ...
  //setup send data to serve
    ...
    savePost(){
        ...
        axioApi.post('/api/admin/store',postdata).then((res) => {
      ...
      <div className="animated fadeIn">
        <Row>
          <Col xs="12" sm="12">
            <Card>
              <CardHeader>
                <strong>Thêm nhà tài khoản</strong>
              ...
              <CardBody>
                <div className="form-group">
                  ...
                  <Input type="text" onChange={this.changeName} id="name" placeholder="Họ Tên" required />
                </div>
                <div className="form-group">
                    <Label htmlFor="imageNumber">Ảnh đại diện</Label>
                    <div>
                ...
                <Row>
                    <Col sm="6">
                        ...
                        <Input type="email" onChange={this.changeEmail} id="email" placeholder="Email" required />
                        </div>
                    </Col>
                    <Col sm="6">
                        <div className="form-group">
                        <Label htmlFor="phone"><strong>Điện thoại</strong></Label>
                        <Input type="text" onChange={this.changePhone} id="phone" placeholder="Điện thoại" required />
                        </div>
                    </Col>
                </Row>
                <div className="form-group">
                  <Label htmlFor="password"><strong>Mật khẩu</strong></Label>
                  <Input type="password" onChange={this.changePassword} id="password" placeholder="Mật khẩu" required />
                </div>
                <div className="form-group">
